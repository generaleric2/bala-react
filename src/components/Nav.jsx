...
export const Nav = () => {
 ...
 return (
    <div className="flex flex-wrap items-center justify-between p-3">
      ...
      {isLoggedIn ? (
        <a href="/login" onClick={handleLogout} className="toggle hidden md:flex w-full md:w-auto px-4 py-2 text-right bg-blue-900 hover:bg-blue-100 text-white md:rounded">LOGOUT</a>
      ) : (
        <a href="/login" className="toggle hidden md:flex w-full md:w-auto px-4 py-2 text-right bg-blue-900 hover:bg-blue-500 text-white md:rounded">LOGIN</a>
      )}
      <a href="/cart" className="flex items-center">
        {!isOpen && <ShoppingCart size={32} />}
