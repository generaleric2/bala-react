      ...
      <div className="w-full max-w-md space-y-4 rounded-lg bg-white p-6 shadow-lg dark:bg-white">
        ...
        <form className="space-y-4" onSubmit={handleUpdate}>
          <div className="space-y-2">
            ...
            <input
              className="flex dark:text-black h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-white input-dark-mode"
              type="email"
              id="email"
              name="email"
